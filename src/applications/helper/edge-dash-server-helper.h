...
//
#ifndef EDGE_DASH_SERVER_HELPER_H
#define EDGE_DASH_SERVER_HELPER_H
...
public:
   ...
   */
  EdgeDashServerHelper (Address ip, uint16_t port, std::string Hostname,
  std::string MPDDirectory, std::string RepresentationsMetaDataFiles,
  std::string RepresentationsSegmentsDirectory);
  EdgeDashServerHelper (Ipv4Address ip, uint16_t port, std::string Hostname,
  std::string MPDDirectory, std::string RepresentationsMetaDataFiles,
  std::string RepresentationsSegmentsDirectory);
  EdgeDashServerHelper (Ipv6Address ip, uint16_t port, std::string Hostname,
  std::string MPDDirectory, std::string RepresentationsMetaDataFiles,
  std::string RepresentationsSegmentsDirectory);
