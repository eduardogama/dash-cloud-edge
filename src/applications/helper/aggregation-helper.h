...
//
#ifndef AGGREGATION_HELPER_H
#define AGGREGATION_HELPER_H
...
class AggregationHelper
{
    public:
        ...
        */
        AggregationHelper (Address ip, uint16_t port, std::string Hostname);

        AggregationHelper (Ipv4Address ip, uint16_t port, std::string Hostname);

        AggregationHelper (Ipv6Address ip, uint16_t port, std::string Hostname);
